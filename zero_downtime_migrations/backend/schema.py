...
class ZeroDownTimeMixin(object):
    ...
    def drop_default(self, model, field):
        set_default_sql, params = self._ZDM_alter_column_default_sql(field, drop=True)
        self.execute_alter_column(model, set_default_sql, params)

    def add_default(self, model, field, default_value):
        set_default_sql, params = self._ZDM_alter_column_default_sql(field, default_value)
        self.execute_alter_column(model, set_default_sql, params)
    ...
    def _ZDM_alter_column_default_sql(self, field, default_value=None, drop=False):
        """
